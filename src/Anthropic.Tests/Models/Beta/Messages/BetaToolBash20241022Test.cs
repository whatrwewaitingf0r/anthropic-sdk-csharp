...
public class BetaToolBash20241022Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaToolBash20241022 copied = new(model);
...
public class BetaToolBash20241022AllowedCallerTest : TestBase
{
    ...
    [InlineData(BetaToolBash20241022AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaToolBash20241022AllowedCaller.CodeExecution20260521)]
