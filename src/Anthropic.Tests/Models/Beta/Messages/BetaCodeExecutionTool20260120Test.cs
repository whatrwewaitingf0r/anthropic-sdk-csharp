...
public class BetaCodeExecutionTool20260120Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BetaCodeExecutionTool20260120
        {
        ...
        List<ApiEnum<string, BetaCodeExecutionTool20260120AllowedCaller>> expectedAllowedCallers =
        [
            BetaCodeExecutionTool20260120AllowedCaller.Direct,
        ];
    ...
    {
        var model = new BetaCodeExecutionTool20260120 { CacheControl = new() { Ttl = Ttl.Ttl5m } };
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaCodeExecutionTool20260120 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class BetaCodeExecutionTool20260120AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.Direct)]
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.CodeExecution20250825)]
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(BetaCodeExecutionTool20260120AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaCodeExecutionTool20260120AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaCodeExecutionTool20260120AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(BetaCodeExecutionTool20260120AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, BetaCodeExecutionTool20260120AllowedCaller> value = rawValue;
