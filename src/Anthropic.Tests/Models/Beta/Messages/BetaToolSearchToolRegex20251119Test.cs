...
public class BetaToolSearchToolRegex20251119Test : TestBase
{
    ...
    public void CopyConstructor_Works()
    {
        ...
        BetaToolSearchToolRegex20251119 copied = new(model);
...
public class BetaToolSearchToolRegex20251119AllowedCallerTest : TestBase
{
    ...
    [InlineData(BetaToolSearchToolRegex20251119AllowedCaller.CodeExecution20260120)]
    [InlineData(BetaToolSearchToolRegex20251119AllowedCaller.CodeExecution20260521)]
