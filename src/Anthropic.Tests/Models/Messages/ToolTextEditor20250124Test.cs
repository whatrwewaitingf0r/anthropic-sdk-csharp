...
public class ToolTextEditor20250124Test : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<ApiEnum<string, ToolTextEditor20250124AllowedCaller>> expectedAllowedCallers =
        [
            ToolTextEditor20250124AllowedCaller.Direct,
        ];
...
public class ToolTextEditor20250124AllowedCallerTest : TestBase
{
    [Theory]
    [InlineData(ToolTextEditor20250124AllowedCaller.Direct)]
    [InlineData(ToolTextEditor20250124AllowedCaller.CodeExecution20250825)]
    [InlineData(ToolTextEditor20250124AllowedCaller.CodeExecution20260120)]
    [InlineData(ToolTextEditor20250124AllowedCaller.CodeExecution20260521)]
    public void Validation_Works(ToolTextEditor20250124AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolTextEditor20250124AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ToolTextEditor20250124AllowedCaller.CodeExecution20260120)]
    [InlineData(ToolTextEditor20250124AllowedCaller.CodeExecution20260521)]
    public void SerializationRoundtrip_Works(ToolTextEditor20250124AllowedCaller rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ToolTextEditor20250124AllowedCaller> value = rawValue;
