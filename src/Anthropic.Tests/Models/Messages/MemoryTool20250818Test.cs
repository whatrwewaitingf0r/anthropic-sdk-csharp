...
public class MemoryTool20250818Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new MemoryTool20250818
        {
        ...
        List<ApiEnum<string, MemoryTool20250818AllowedCaller>> expectedAllowedCallers =
        [
            MemoryTool20250818AllowedCaller.Direct,
        ];
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MemoryTool20250818>(
            json,
    ...
    {
        var model = new MemoryTool20250818 { CacheControl = new() { Ttl = Ttl.Ttl5m } };
    ...
    public void CopyConstructor_Works()
    {
        ...
        MemoryTool20250818 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class MemoryTool20250818AllowedCallerTest : TestBase
{
    [Theory]
    ...
    public void Validation_Works(MemoryTool20250818AllowedCaller rawValue)
    {
        ...
        ApiEnum<string, MemoryTool20250818AllowedCaller> value = rawValue;
        value.Validate();
    }
    ...
    {
        var value = JsonSerializer.Deserialize<ApiEnum<string, MemoryTool20250818AllowedCaller>>(
    ...
    public void SerializationRoundtrip_Works(MemoryTool20250818AllowedCaller rawValue)
    {
        ...
        var deserialized = JsonSerializer.Deserialize<
            ApiEnum<string, MemoryTool20250818AllowedCaller>
