...
public class CodeExecutionTool20250522Test : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CodeExecutionTool20250522
        {
    ...
    {
        var model = new CodeExecutionTool20250522 { CacheControl = new() { Ttl = Ttl.Ttl5m } };
    ...
    public void CopyConstructor_Works()
    {
        ...
        CodeExecutionTool20250522 copied = new(model);
