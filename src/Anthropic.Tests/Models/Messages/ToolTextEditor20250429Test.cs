...
public class ToolTextEditor20250429Test : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        List<ApiEnum<string, ToolTextEditor20250429AllowedCaller>> expectedAllowedCallers =
        [
            ToolTextEditor20250429AllowedCaller.Direct,
        ];
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolTextEditor20250429 copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ToolTextEditor20250429AllowedCallerTest : TestBase
{
    [Theory]
    ...
    public void Validation_Works(ToolTextEditor20250429AllowedCaller rawValue)
    {
        ...
        ApiEnum<string, ToolTextEditor20250429AllowedCaller> value = rawValue;
        value.Validate();
    }
